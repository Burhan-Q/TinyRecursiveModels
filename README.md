...
This repository now includes an adaptation for **object detection action verification**! You can use TRM's recursive reasoning to verify if action descriptions match detected objects in images. See [DETECTION_README.md](DETECTION_README.md) for details.

Quick start with the toy COCO8 dataset:
```bash
# Download and prepare COCO8 dataset
